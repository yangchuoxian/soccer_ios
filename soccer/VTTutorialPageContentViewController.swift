...
class VTTutorialPageContentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.button_enterApp.setTitle("进入" + AppDisplayName, for: UIControlState())
        ...
        if self.pageIndex == (self.numOfTutorialPages - 1) {
            self.button_enterApp.isEnabled = true
            self.button_enterApp.isHidden = false
        }
    }
    ...
    @IBAction func startToUseApp(_ sender: AnyObject) {
